...
<body>
    <header class="container text-center">
        <img src="img/avatar-perfil.png" alt="avatar do vinicius" class="rounded-circle" width="150" height="150"
            srcset="">
        <p class="lead">Eu sou Vinicius_</p>
        <h1>Eu estudo Programação</h1>
        <p>Sou estudante do ensin medio!</p>
